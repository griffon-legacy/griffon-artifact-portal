      ...
      <div class="row">
        ...
        <div class="span10">
          <address>
            ...
            <g:fieldValue bean="${profileInstance.user}" field="fullName"/>
            <small>(<g:message code="user.membership.label" default="Member since"/></small>
            <g:formatDate date="${profileInstance.user.dateCreated}" format="MMM dd, yyyy"/><small>)</small>
            <br/>
