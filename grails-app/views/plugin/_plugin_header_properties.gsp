...
<div class="fieldcontain">
    <span id="toolkits-label" class="property-label"><g:message
        code="plugin.toolkits.label"
...
<div class="fieldcontain platforms">
    <span id="platforms-label" class="property-label"><g:message
        code="plugin.platforms.label"
    ...
    <ul>
        <g:each in="${platforms}" var="platform">
            <li>
                <g:img dir="images" class="thumbnail"
                       file="logo-${platform.trim()}.gif"
...
<div class="fieldcontain">
    <span id="framework-label" class="property-label"><g:message
        code="plugin.framework.label"
