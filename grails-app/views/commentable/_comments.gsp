...
<div id="addComment" class="addComment">
    <h2 class="addCommentTitle">
        <a href="#commentEditor"
           onclick="document.getElementById('addCommentContainer').style.display = '';">
            <g:message code="comment.add.title"
                       default="Post a Comment"></g:message>
        </a>
    </h2>
    ...
    <div id="addCommentContainer" class="addCommentContainer"
        ...
        <g:formRemote name="addCommentForm"
                      url="[controller: 'commentable', action: 'add']"
                      update="comments">
            ...
            <g:hiddenField name="commentLink.commentRef"
                           value="${commentable.id}"/>
            <g:hiddenField name="commentLink.type"
                           value="${commentable.class.name}"/>
            <g:hiddenField name="commentPageURI"
                           value="${request.forwardURI}"></g:hiddenField>
